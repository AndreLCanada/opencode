export const dict = {
  ...
  "command.schedule.frequency.daily": "Every day",
  "command.schedule.frequency.weekdays": "Weekdays only",
  "command.schedule.frequency.weekly": "Every week",
  "command.schedule.frequency.monthly": "Every month",
  "command.schedule.frequency.custom": "Custom (cron)",
  "command.schedule.hour": "Hour",
  "command.schedule.minute": "Minute",
  "command.schedule.dayOfWeek": "Day of week",
  "command.schedule.dayOfMonth": "Day of month",
  ...
  "command.schedule.error.cronRequired": "Cron expression is required",
  "command.schedule.error.cronInvalid": "Invalid cron expression",
  "command.schedule.error.modelRequired": "Select a model first",
  "command.schedule.error.agentRequired": "Select an agent first",
